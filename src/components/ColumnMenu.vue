<template>
    <div>
        ...
        <GridColumnMenuFilter :column="column" :filterable="filterable" :filter="filter" @filterfocus="handleFocus"
                        ...
                        <div class="k-column-list">
                            <div :key="idx" class="k-column-list-item" v-for="(column, idx) in currentColumns">
                                <span>
                                    ...
                                    <label :for="'column-visibility-show-' + idx" :class="'k-checkbox-label'"
...
export default {
    ...
    methods: {
        ...
        filterChange(newDescriptor) {
            this.$emit('filterchange', newDescriptor);
        },
        sortChange(newDescriptor) {
        ...
        columnShowHide(state) {
            console.log('columnShowHide', state);
